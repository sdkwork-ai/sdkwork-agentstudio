# Runbook — sdkwork-agentstudio deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-agentstudio-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-agentstudio/bundle`, loads the image, starts
